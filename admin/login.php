           ...
           <form method="POST">
            <div class="mb-md-5 mt-md-4 pb-5">
              ...
              <label class="form-label" for="typeEmailX">Email</label>
                ...
                <input type="email" name="email_admin" id="typeEmailX" class="form-control form-control-lg" />
              </div>

              <div class="form-outline form-white mb-4">
              <label class="form-label" for="typePasswordX">Password</label>

                <input type="password" name="pass_admin" id="typePasswordX" class="form-control form-control-lg" />
              </div>
              <?php
                ...
                $admin="SELECT * FROM   admin  WHERE email= '$a1' and password='$a2' " ;
